...
const Problem = () => {
  ...
  <div
    ...
    className={`transition-all duration-1000 ${
      solutionVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
    }`}
  >
      ...
      <div>
        ...
        <div className="space-y-3">
          {problems.map((p, i) => (
            <div
              key={i}
              className="bg-white rounded-lg p-4 shadow-sm border border-red-100 group hover:shadow-md transition-all duration-300"
            >
      ...
      <div>
        ...
        <div className="space-y-3">
          {solutions.map((s, i) => (
            <div
              key={i}
              className="bg-white rounded-lg p-4 shadow-sm border border-blue-100 group hover:shadow-md transition-all duration-300"
            >
              <div className="flex items-center gap-3">
