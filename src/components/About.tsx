...
const AboutTechnovere = () => {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="bg-white py-20 px-4 lg:px-20 relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mb-4">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-5xl font-bold text-blue-900 mb-6">
   About <span className='text-yellow-400'>Technovere</span>
            </h2>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4">Why Choose Technovere?</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group bg-white border border-gray-200 p-8 rounded-xl hover:shadow-lg hover:border-yellow-400 transition-all duration-300"
                >
                  <div className="flex items-start gap-6">
                    <div className="flex-shrink-0">
                      <div className="w-14 h-14 bg-yellow-400 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <IconComponent className="w-7 h-7 text-black" />
                      </div>
                    </div>
                    <div className="flex-1">
                      <h4 className="text-blue-900 font-bold text-xl mb-3 group-hover:text-blue-700 transition-colors duration-300">
                        {feature.title}
                      </h4>
        ...
        {/* Who We Serve */}
        <div className="bg-gray-50 -mx-4 lg:-mx-20 px-4 lg:px-20 py-16 mb-20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h3 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4">Who We Serve</h3>
              <div className="w-24 h-1 bg-yellow-400 mx-auto mb-6"></div>
            </div>
        ...
        {/* CTA Section */}
        {/* <div className="text-center bg-blue-900 -mx-4 lg:-mx-20 px-4 lg:px-20 py-16">
